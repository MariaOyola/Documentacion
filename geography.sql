-- ============================================
-- AIRLINE DATABASE - SCRIPT CORREGIDO
-- ============================================
-- Errores corregidos:
--   E-001: UUIDs falsos en INSERT → subqueries reales
--   E-002: Sin BEGIN/COMMIT → envuelto en transacción
--   E-003: Orden de dependencias → respetado correctamente
--   E-004: FK compuesta redundante en seat_assignment → eliminada FK simple a flight_segment
--   E-005: Typo uq_payment_umethod_name → corregido a uq_payment_method_name
--   E-006: miles_transaction sin FK al origen → agregado ticket_id nullable
-- Decisiones ADR implementadas:
--   D-001: Índice parcial para tier activo único en loyalty_account_tier
--   D-002: Campos de auditoría created_by, updated_by, deleted_at en todas las tablas
--   D-003: flight con origin_airport_id y destination_airport_id como ruta maestra
--   D-004: Índice único parcial en person para unicidad natural
--   D-005: gender_code como NOT NULL
--   D-006: Índice adicional en flight_number
-- ============================================
...
CREATE TABLE person (
    ...
    birth_date              date,
    -- ADR D-005: gender_code NOT NULL — obligatorio por normativa de aviación civil
    gender_code             varchar(1)  NOT NULL DEFAULT 'X',
    created_at              timestamptz NOT NULL DEFAULT now(),
    updated_at              timestamptz NOT NULL DEFAULT now(),
    created_by              uuid,
    updated_by              uuid,
    deleted_at              timestamptz,
    CONSTRAINT ck_person_gender CHECK (gender_code IN ('F', 'M', 'X'))
);

-- ADR D-004: índice único parcial para unicidad natural de persona
-- Aplica solo cuando birth_date está presente (casos con datos completos)
CREATE UNIQUE INDEX uq_person_natural_identity
    ON person (first_name, last_name, birth_date)
...
-- Ahora que user_account existe, podemos agregar las FK de auditoría
-- a las tablas anteriores via ALTER TABLE
ALTER TABLE time_zone      ADD CONSTRAINT fk_time_zone_created_by      FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE time_zone      ADD CONSTRAINT fk_time_zone_updated_by      FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE continent      ADD CONSTRAINT fk_continent_created_by      FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE continent      ADD CONSTRAINT fk_continent_updated_by      FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE country        ADD CONSTRAINT fk_country_created_by        FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE country        ADD CONSTRAINT fk_country_updated_by        FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE state_province ADD CONSTRAINT fk_state_province_created_by FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE state_province ADD CONSTRAINT fk_state_province_updated_by FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE city           ADD CONSTRAINT fk_city_created_by           FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE city           ADD CONSTRAINT fk_city_updated_by           FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE district       ADD CONSTRAINT fk_district_created_by       FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE district       ADD CONSTRAINT fk_district_updated_by       FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE address        ADD CONSTRAINT fk_address_created_by        FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE address        ADD CONSTRAINT fk_address_updated_by        FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE currency       ADD CONSTRAINT fk_currency_created_by       FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE currency       ADD CONSTRAINT fk_currency_updated_by       FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE airline        ADD CONSTRAINT fk_airline_created_by        FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE airline        ADD CONSTRAINT fk_airline_updated_by        FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE person_type    ADD CONSTRAINT fk_person_type_created_by    FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE person_type    ADD CONSTRAINT fk_person_type_updated_by    FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE document_type  ADD CONSTRAINT fk_document_type_created_by  FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE document_type  ADD CONSTRAINT fk_document_type_updated_by  FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE contact_type   ADD CONSTRAINT fk_contact_type_created_by   FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE contact_type   ADD CONSTRAINT fk_contact_type_updated_by   FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE person         ADD CONSTRAINT fk_person_created_by         FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE person         ADD CONSTRAINT fk_person_updated_by         FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE person_document ADD CONSTRAINT fk_person_document_created_by FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE person_document ADD CONSTRAINT fk_person_document_updated_by FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE person_contact ADD CONSTRAINT fk_person_contact_created_by FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE person_contact ADD CONSTRAINT fk_person_contact_updated_by FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE user_status    ADD CONSTRAINT fk_user_status_created_by    FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE user_status    ADD CONSTRAINT fk_user_status_updated_by    FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE security_role  ADD CONSTRAINT fk_security_role_created_by  FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE security_role  ADD CONSTRAINT fk_security_role_updated_by  FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
ALTER TABLE security_permission ADD CONSTRAINT fk_security_perm_created_by FOREIGN KEY (created_by) REFERENCES user_account(user_account_id);
ALTER TABLE security_permission ADD CONSTRAINT fk_security_perm_updated_by FOREIGN KEY (updated_by) REFERENCES user_account(user_account_id);
...
-- ADR D-001: índice parcial — garantiza un solo tier activo por cuenta en el motor
...
CREATE TABLE miles_transaction (
    ...
    loyalty_account_id      uuid        NOT NULL REFERENCES loyalty_account(loyalty_account_id),
    -- E-006 corregido: ticket_id como FK opcional para trazabilidad de origen
...
CREATE TABLE flight (
    ...
    -- ADR D-003: ruta maestra para consultas directas sin JOIN a segmentos
    ...
    CONSTRAINT ck_flight_airports   CHECK (origin_airport_id <> destination_airport_id)
);

-- ADR D-006: índice adicional en flight_number para búsquedas sin filtro de aerolínea
...
-- Ahora que ticket existe, agregamos la FK en miles_transaction

ALTER TABLE miles_transaction ADD COLUMN ticket_id uuid;

ALTER TABLE miles_transaction ADD CONSTRAINT fk_miles_transaction_ticket
...
CREATE TABLE seat_assignment (
    ...
    -- E-004 corregido: solo FK compuesta, elimina ambigüedad con FK simple
...
CREATE TABLE payment_method (
    ...
    -- E-005 corregido: typo uq_payment_umethod_name → uq_payment_method_name
...
COMMENT ON TABLE seat_assignment   IS 'Asignacion de asiento controlada unicamente por FK compuesta (ticket_segment_id, flight_segment_id). FK simple a flight_segment eliminada para evitar inconsistencias silenciosas. Ver ADR E-004.';
COMMENT ON TABLE loyalty_account_tier IS 'Historial de tiers. Un unico tier activo por cuenta garantizado por indice parcial WHERE expires_at IS NULL. Ver ADR D-001.';
COMMENT ON TABLE invoice_line      IS 'Detalle facturable sin totales derivados persistidos, para preservar 3FN.';
COMMENT ON TABLE miles_transaction IS 'Transacciones de millas con trazabilidad opcional al ticket origen via ticket_id. Ver ADR E-006.';
COMMENT ON TABLE flight            IS 'Incluye origin_airport_id y destination_airport_id como ruta maestra desnormalizada para consultas directas sin JOIN a segmentos. Ver ADR D-003.';
COMMENT ON COLUMN person.gender_code IS 'Obligatorio por normativa de aviacion civil. Valores: F, M, X. Ver ADR D-005.';

-- ============================================
-- INDEXES (originales + ADR D-006)
-- ============================================
...
CREATE INDEX idx_miles_transaction_ticket_id        ON miles_transaction(ticket_id);
...
CREATE INDEX idx_flight_origin_airport              ON flight(origin_airport_id);
CREATE INDEX idx_flight_destination_airport         ON flight(destination_airport_id);
...
-- ============================================
-- DATA SEED — E-001, E-002, E-003 CORREGIDOS
-- ============================================
-- E-002: todo dentro de una transacción
-- E-003: orden correcto de dependencias
-- E-001: UUIDs reales via subqueries, no strings falsos

BEGIN;

    -- 1. continent (sin dependencias)
    INSERT INTO continent (continent_code, continent_name)
    VALUES ('SA', 'South America');

    -- 2. time_zone (sin dependencias)
    INSERT INTO time_zone (time_zone_name, utc_offset_minutes)
    VALUES ('America/Bogota', -300);

    -- 3. country (depende de continent)
    ...
    -- 4. state_province (depende de country)
    ...
    -- 5. city (depende de state_province Y time_zone)
    INSERT INTO city (state_province_id, time_zone_id, city_name)
    VALUES (
        (SELECT state_province_id FROM state_province
            WHERE state_name = 'Huila'
            AND country_id = (SELECT country_id FROM country WHERE iso_alpha2 = 'CO')),
        (SELECT time_zone_id FROM time_zone WHERE time_zone_name = 'America/Bogota'),
        'Neiva'
    );

    -- 6. district (depende de city)
    ...
    VALUES (
        (SELECT district_id FROM district WHERE district_name = 'Centro'
            AND city_id = (SELECT city_id FROM city WHERE city_name = 'Neiva')),
        'Calle 10 #5-20',
        2.9273,
        -75.2819
    );

    -- 8. currency (sin dependencias)
